...
use rustcanvas::{create_canvas, Canvas2dMsg, CanvasContextType, CanvasMsg, CompositionOrBlending,
                 CompositionStyle, FillOrStrokeStyle};
...
fn main() {
  ...
  renderer
    .send(CanvasMsg::Canvas2d(Canvas2dMsg::SetGlobalComposition(
      CompositionOrBlending::Composition(CompositionStyle::SrcOver),
    )))
    .unwrap();
  renderer
    .send(CanvasMsg::Canvas2d(Canvas2dMsg::DrawImage(
      f1_raw,
  ...
  renderer
    .send(CanvasMsg::Canvas2d(Canvas2dMsg::SetFontStyle(
      String::from("normal  195px \"PingFang TC\""),
    )))
    .unwrap();
  renderer
  ...
  renderer
    .send(CanvasMsg::Canvas2d(Canvas2dMsg::SetFontStyle(
      String::from("normal  51px \"PingFang TC\""),
    )))
    .unwrap();
  ...
  renderer
    .send(CanvasMsg::Canvas2d(Canvas2dMsg::SetFontStyle(
      String::from("normal  90px \"PingFang TC\""),
    )))
    .unwrap();
  renderer
    .send(CanvasMsg::Canvas2d(Canvas2dMsg::FillText(
  ...
  renderer
    .send(CanvasMsg::Canvas2d(Canvas2dMsg::DrawImage(
      ...
      Rect::new(
        Point2D::new(964.3750419449117 - 48.0, 1791.263570829159 - 68.0),
        Size2D::new(96.0, 136.0),
      ),
  ...
  renderer
    .send(CanvasMsg::Canvas2d(Canvas2dMsg::DrawImage(
      ...
      Rect::new(
        Point2D::new(165.3658536585367 - 135.0, 1754.8997233368143 - 135.0),
        Size2D::new(270.0, 270.0),
      ),
